...
function updateContent() {
    ...
    document.querySelectorAll(".btn.hire-me").forEach(btn => {
        ...
        btn.addEventListener("click", function(e) {
            ...
            if (contactSection) {
                changeSection({ getAttribute: () => "#contact" });
    ...
    document.querySelector(".about-text h3").innerHTML = `${t.aboutTitle} <span>${t.webDeveloper}</span>`;
    document.querySelector(".about-text p").textContent = t.aboutText;
    
    // Update personal info
    const infoItems = document.querySelectorAll(".info-item p");
    infoItems[0].innerHTML = `${t.birthday}: <span>18 Feb 2004</span>`;
    infoItems[1].innerHTML = `${t.age}: <span>20</span>`;
    infoItems[2].innerHTML = `${t.email}: <span>game3918@hotmail.com</span>`;
    infoItems[3].innerHTML = `${t.degree}: <span>Computer Engineer</span>`;
    infoItems[4].innerHTML = `${t.city}: <span>São Paulo</span>`;
    infoItems[5].innerHTML = `${t.freelance}: <span>${t.available}</span>`;
    ...
    timelineItems[0].querySelector(".timeline-date").innerHTML = `<i class="fa fa-calendar"></i> ${t.course1.period}`;
    ...
    timelineItems[1].querySelector(".timeline-date").innerHTML = `<i class="fa fa-calendar"></i> ${t.course2.period}`;
    timelineItems[1].querySelector(".timeline-title").textContent = t.course2.title;
    timelineItems[1].querySelector(".timeline-text").textContent = t.course2.description;
    ...
    const services = [
        { title: "mobileFriendly", desc: "mobileFriendlyDesc" },
        { title: "webAppDev", desc: "webAppDevDesc" },
        { title: "visualIdentity", desc: "visualIdentityDesc" },
        { title: "customWebDev", desc: "customWebDevDesc" },
        { title: "seoEnhancement", desc: "seoEnhancementDesc" },
        { title: "digitalMarketing", desc: "digitalMarketingDesc" }
    ];
    ...
    document.querySelector(".portfolio-heading h2").textContent = t.lastProjects;
    ...
    contactInfoItems[2].textContent = t.email;
    ...
    document.querySelector("h4.contact-sub-title:last-of-type").textContent = t.replyPrompt;
...
function changeSection(element) {
    ...
    const newSectionIndex = Array.from(allSection).findIndex(section => section.id === target);
